        ...
        {linked ? (
            ...
            <Alert color="green" my="lg">
              <Group noWrap>
                ...
                <Text
                  size="xl"
                  sx={{ lineHeight: 1.2 }}
                >{`We've updated your Discord account with the latest data from ShantsTech`}</Text>
              </Group>
            </Alert>
          ...
          <Stack spacing="md">
            <Title order={3} sx={{ lineHeight: 1.2 }}>
              Connect your Discord account to your ShantsTech account
            </Title>
            <Text>{`Take your ShantsTech accolades into Discord to get special roles and perks by connecting your account.`}</Text>
