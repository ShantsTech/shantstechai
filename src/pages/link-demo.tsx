...
import { useShantsTechLink, useShantsTechLinkStore } from '~/components/ShantsTechLink/ShantsTechLinkProvider';
import { ShantsTechLinkSvg } from '~/components/ShantsTechLink/ShantsTechLinkSvg';
import { Meta } from '~/components/Meta/Meta';
import { PlanBenefitList } from '~/components/Stripe/PlanBenefitList';

function Home() {
  // const activities = useShantsTechLinkStore((state) => state.activities);
  const { resources, connected, runCommand, instance } = useShantsTechLink();
  ...
  const handleRunDownload = async () => {
    runCommand({
      ...
      resource: {
        ...
        url: 'https://shants-tech.com/api/download/models/1144',
        previewImage:
          'https://imagecache.shants-tech.com/xG1nkqKTMzGDvpLrqFT7WA/3cabeab1-a1c9-4a02-ac76-3a9ed69a1700/width=450',
    ...
    runCommand({
      ...
      resource: {
        ...
        url: 'https://shants-tech.com/api/download/models/6278',
        type: 'Checkpoint',
        previewImage:
          'https://imagecache.shants-tech.com/xG1nkqKTMzGDvpLrqFT7WA/35b84925-765b-416b-0c5a-15bf54a64c00/width=450',
      },
    });
  };
      ...
      <Container size="xl">
        <Stack spacing={4}>
          ...
          <Text mb="md" color="dimmed">
            Time to connect your Stable Diffusion instance to your ShantsTech Account.
          </Text>
          <List type="ordered">
            <List.Item>
              In your{' '}
