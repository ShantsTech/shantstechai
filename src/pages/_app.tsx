...
import { ShantsTechLinkProvider } from '~/components/ShantsTechLink/ShantsTechLinkProvider';
...
function MyApp(props: CustomAppProps) {
  ...
  return (
    <>
      <Head>
        <title>ShantsTech | Share your models</title>
        <script defer data-domain="shants-tech.com" src="https://plausible.io/js/script.js"></script>
        <MetaPWA />
      </Head>
