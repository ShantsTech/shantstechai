...
export default function QuestionInfoModal({ context, id }: ContextModalProps) {
  return (
    <Stack>
      ...
      <List type="ordered">
        <List.Item>
          A user creates an account on ShantsTech and poses a question on a particular topic.
        </List.Item>
        <List.Item>
        ...
        <List.Item>
          ShantsTech ranks the responses based on the upvotes and downvotes, the most highly ranked
