...
const { openModal, Modal } = createContextModal({
  ...
  Element: ({ context, props }) => {
    ...
    const { connected, instance, createInstance } = useShantsTechLink();
    ...
    return (
      <Stepper active={active} onStepClick={setActive} breakpoint="sm" allowNextStepsSelect={false}>
        <Stepper.Step label="About ShantsTech Link" description="Learn what it does">
          <Stack mt="sm">
            <Stack spacing={4}>
              <Title order={3} sx={{ lineHeight: 1.1 }}>
                About ShantsTech Link
              </Title>
              <Text>{`ShantsTech Link allows you to interact with your Stable Diffusion instance in realtime wherever it is from any device.`}</Text>
                  ...
                  },
                  {
                    content: (
                      <Text
                        component="a"
                        variant="link"
                        href="/github/wiki/ShantsTech-Link-Integration"
                        target="_blank"
                      >
          ...
          <Stack mt="sm">
            <Stack spacing={4}>
              <Title order={3} mb={0} sx={{ lineHeight: 1 }}>
                Prepare Stable Diffusion for ShantsTech Link
              </Title>
...
export const openShantsTechLinkModal = openModal;
