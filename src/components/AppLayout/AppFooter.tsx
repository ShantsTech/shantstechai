  ...
  return (
    <Footer className={cx(classes.root, { [classes.down]: !showFooter })} height="auto" p="sm">
      <Group spacing={mobile ? 'sm' : 'lg'} sx={{ flexWrap: 'nowrap' }}>
        ...
        >
          &copy; ShantsTech {new Date().getFullYear()}
        </Text>
        {showHash && hash && (
          <Stack spacing={2}>
        ...
        <Group spacing={0} sx={{ flexWrap: 'nowrap' }}>
          ...
          <Button
            component="a"
            href="https://github.com/ShantsTech/shantstechai"
            {...buttonProps}
            target="_blank"
          >
            GitHub
        ...
        <Button
          component="a"
          href="https://github.com/ShantsTech/shantstechai/discussions/categories/ideas"
          ml="auto"
          variant="light"
          color="yellow"
          target="_blank"
